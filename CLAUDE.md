...
Single-package Go library (`package agileconfig`) — no sub-packages. Internal types are unexported; public API includes `Client`, `MultiClient`, `NewClient`, `NewMultiClient`, `Option`, `MultiOption`, and `With*` functions.
